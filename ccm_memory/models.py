from ccm_memory.base import AbstractMatrixMemory, Activation, Vector, MemoryPair
from ccm_memory.abstract import AbstractMemory
import numpy as np
from ccm_memory.utils import softmax


class ModernHopfield(AbstractMatrixMemory):
...
class ChainedMatrixMemory(AbstractMatrixMemory):
    # Required structure for Stateful attention memory implementation
